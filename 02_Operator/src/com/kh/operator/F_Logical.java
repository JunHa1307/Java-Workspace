...
public class F_Logical {
	 ...
	 * 
	 * AND연산자: 논리값 && 논리값
	 * 			왼쪽, 오른쪽 논리값이 둘다 TRUE여야 최종결과 TRUE 가 반환됨
	 * 
	 * OR 연산자: 논리값 || 논리값
	 * 			왼쪽과 오른쪽 논리값 중 어느하나라도 TRUE면 최종결과가 TRUE
	 * 
	 */
	public void method1() {
		//사용자가 입력한 어떤 정수값이 양수이면서 짝수인지 확인하기
	...
	public void method3() {
		 ...
		 * 두개의 조건이 모두 false 일 경우 최종결과값은 false
		 * 
		 */
	}
	public void method4() {
